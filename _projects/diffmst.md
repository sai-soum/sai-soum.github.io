...
We provide audio examples of the reference songs, the mixes generated by our best performing model Diff-MST AF-16, and Equal loudness mix (which is normalised sum of the tracks without any mixing transformation.) The audio examples are normalized to -16.0 dBFS.
